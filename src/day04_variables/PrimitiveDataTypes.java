...
public class PrimitiveDataTypes {
    public static void main(String[] args) {
        ...
        System.out.println(2024);       // data type here is int

        int addressNumber = 244432;         // declared a variable called addressNumber and assigned 244432
        System.out.println(addressNumber);  // datatype here is int
        System.out.println(244432);         // datatype here is int

        long bigNumber;
        bigNumber = 9534663465633L;         // adding L to the end of the number tells the compiler it's a long number
