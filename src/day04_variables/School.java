...
public class School {
    public static void main(String[] args) {
        ...
        int totalNumberOfStudents = numberOfStudentsInGradeOne + numberOfStudentsInGradeTwo +
                numberOfStudentsInGradeThree + numberOfStudentsInGradeFour + numberOfStudentsInGradeFive;

        double numberOfSchoolDays = 100.5;
        double numberOfSnowDays = 5.5;
        double averageGpaInSchool = 3.6;

        System.out.println("Number of students Grade 1: " + numberOfStudentsInGradeOne);
        System.out.println("Number of students Grade 1: " + numberOfStudentsInGradeTwo);
        System.out.println("Number of students Grade 1: " + numberOfStudentsInGradeThree);
        System.out.println("Number of students Grade 1: " + numberOfStudentsInGradeFour);
        System.out.println("Number of students Grade 1: " + numberOfStudentsInGradeFive);
