...
public class Third {
    public static void main(String[] args) {
        ...
        //System.out.println( obj.two ); // since two has protected access modifier and since there is no IS-A relation between Third class and First class and Since these two classes are in different packaged, we CANNOT have access
